...
GitHub is a massive place, with a crazy amount of features

You can do project management, sync up continuous integration for testing, host webpages, submit homework, and who all kinds of other stuff. 

One really nice feature we'll demonstrate here are [Issues](https://guides.github.com/features/issues/) 

Think of issues as a to-do list stored in GitHub that can be explicitly linked to lines of code / commits / pull requests
...
- Track the general workflow of a project
- Home maintence tasks in the Scheuerell household 🤓
