...
```{r, echo=FALSE}
knitr::include_graphics(here("presentations","imgs","conflict.png"))
```
...
We have all given thanks for the "undo" feature at some time. 
...
Clear commit messages make it very easy to go back to specific events
  - Reset to commit "Model finally converges"
...
If I'm being honest, I use [GitKraken](https://www.gitkraken.com/) for these kinds of more complex operations
...
Git can be hard sometimes! If your job isn't to be a software developer,it's OK to take shortcuts sometimes
].pull-right[
...
- Allows others (and yourself) to easily reproduce your results in the future and on different machines
